            ...
            <div class="dev-page-footer dev-page-footer-fixed"> <!-- dev-page-footer-closed dev-page-footer-fixed -->
                <ul class="dev-page-footer-controls">
                    <li><a href="<?php echo base_url()?>/login/logout" class="tip" title="Logoff"><i class="fa fa-power-off"></i></a></li>
                   
                    <li class="pull-right">
                        <a class="dev-page-sidebar-minimize tip" title="encolher menu"><i class="fa fa-outdent"></i></a>
                    </li>
                </ul>
        ...
        <script type="text/javascript" src="<?php echo base_url('assets');?>/js/plugins/bootstrap-datetimepicker/bootstrap-datetimepicker.js"></script>
